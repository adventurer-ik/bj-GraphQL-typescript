import { Box, Button, Divider, FormControl, FormErrorMessage, FormLabel, Heading, Input, Stack, Text, useColorModeValue } from '@chakra-ui/react';
    ...
    <Box rounded={"lg"} bg={useColorModeValue('white','gray.700')} boxShadow="lg" p={8}>
      <Stack as={"form"} spacing={4} onSubmit={handleSubmit(onSubmit)}>
        <FormControl isInvalid={!!errors.loginInput?.emailOrUsername}>
          ...
          <Input type={"emailOrUsername"} placeholder="이메일 또는 아이디를 입력하세요." {...register('loginInput.emailOrUsername', {
        ...
        <FormLabel>암호</FormLabel>
          <Input type={"password"} placeholder="********" {...register('loginInput.password', {
            required: '암호를 입력해주세요.'
          })}/>
          <FormErrorMessage>
